...
class NotificationManager:
    ...
    def __init__(self):
        ...
        self.connection.login(os.environ["EMAIL_LOGIN"], os.environ["EMAIL_PASSWORD"])
    ...
    def send_email(self, email_recipient, message_body):
        message = f"Subject: Low air fare price alert!\n\n{message_body}"
        self.connection.sendmail(os.environ["EMAIL_FROM"], email_recipient, message)
