...
class FlightData:
    ...
    def __init__(self, price, origin_airport, destination_airport, out_date, return_date, stops):
        ...
        - stops: The number of stops in the flight.
        """
        self.price = price
        ...
        print("FlightData", self.price, self.origin_airport, self.destination_airport, self.out_date, self.return_date, self.stops)
